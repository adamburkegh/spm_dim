 ...
 *
 */
public class RelevanceDRSmallLogMeasure implements StochasticLogCachingMeasure{
	...
	public RelevanceDRSmallLogMeasure(PlayoutGenerator generator) {
		super();
		this.generator = generator;
		drCalc = new DimensionalRealismSmallLogCalculator(generator,FACTORS,CONSTANT,MAX,MIN);
	}
	
	public RelevanceDRSmallLogMeasure() {
		super();
	}
	...
	public Measure getMeasure() {
		return Measure.RELEVANCE_DR_SL;
	}
