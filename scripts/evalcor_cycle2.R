...
resfile <-  paste(workingPath,"eval2",nfactors,ctlogns,".txt",sep="") 
...
corheatmap(pcaearth,"em2","Earth Movers Eval" , dimlabels=dlabels)
corheatmap(pcaent,"ent2","Entropy Eval",  dimlabels=dlabels)
#corheatmap(pcaee,"eval2","Eval", dimlabels=dlabels)
corheatmaprowlabel(pcaee,"eval2","Eval", dimlabels=dlabels, rowlabels=rlabels)
...
write.csv(rdee, paste(workingPath,"eval_c2.csv",sep=""), row.names=FALSE)